...
__global__ void solve_advection_implicit_diffusion_projection_device_UV(cudaComplex *ux_hat_d, cudaComplex *uy_hat_d, cudaComplex *uz_hat_d, real* din_diffusion, int Nx, int Ny, int Nz, real Re, real dt,cudaComplex *Qx_hat_d, cudaComplex *Qy_hat_d, cudaComplex *Qz_hat_d, real *AM_11_d, real *AM_22_d, real *AM_33_d,  real *AM_12_d, real *AM_13_d, real *AM_23_d) {
...
//assamble diffusion matrix
		real G_implicit=(1.0+din_diffusion[IN(j,k,l)]*dt/Re);



		ux_hat_d[IN(j,k,l)].x=(dt*AM_Q_x_Re+ux_hat_d[IN(j,k,l)].x-dt*Qx_hat_d[IN(j,k,l)].x)/G_implicit;
		ux_hat_d[IN(j,k,l)].y=(dt*AM_Q_x_Im+ux_hat_d[IN(j,k,l)].y-dt*Qx_hat_d[IN(j,k,l)].y)/G_implicit;
		
		uy_hat_d[IN(j,k,l)].x=(dt*AM_Q_y_Re+uy_hat_d[IN(j,k,l)].x-dt*Qy_hat_d[IN(j,k,l)].x)/G_implicit;
		uy_hat_d[IN(j,k,l)].y=(dt*AM_Q_y_Im+uy_hat_d[IN(j,k,l)].y-dt*Qy_hat_d[IN(j,k,l)].y)/G_implicit;

		uz_hat_d[IN(j,k,l)].x=(dt*AM_Q_z_Re+uz_hat_d[IN(j,k,l)].x-dt*Qz_hat_d[IN(j,k,l)].x)/G_implicit;
		uz_hat_d[IN(j,k,l)].y=(dt*AM_Q_z_Im+uz_hat_d[IN(j,k,l)].y-dt*Qz_hat_d[IN(j,k,l)].y)/G_implicit;
...
void solve_advection_implicit_diffusion_projection_UV(dim3 dimGrid_C, dim3 dimBlock_C, int Nx, int Ny, int Nz, real* din_diffusion_d, cudaComplex *vx_hat_d, cudaComplex *vy_hat_d, cudaComplex *vz_hat_d, real Re, real dt,cudaComplex *Qx_hat_d, cudaComplex *Qy_hat_d, cudaComplex *Qz_hat_d, real *AM_11_d, real *AM_22_d, real *AM_33_d,  real *AM_12_d, real *AM_13_d, real *AM_23_d){
	

	solve_advection_implicit_diffusion_projection_device_UV<<<dimGrid_C, dimBlock_C>>>(vx_hat_d, vy_hat_d, vz_hat_d, din_diffusion_d, Nx, Ny, Nz, Re, dt, Qx_hat_d, Qy_hat_d, Qz_hat_d, AM_11_d, AM_22_d, AM_33_d, AM_12_d, AM_13_d, AM_23_d);
